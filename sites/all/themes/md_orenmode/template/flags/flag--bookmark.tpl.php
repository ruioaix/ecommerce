...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
    <a href="<?php print $link_href; ?>" title="<?php print $link_text; ?>" class="<?php print $flag_classes ?>" rel="nofollow"><?php (strpos($flag_classes, 'unflag-action') !== FALSE) ? print '<i class="fa fa-heart"></i>' : print '<i class="fa fa-heart-o"></i>'; ?><span class="title"><?php print $link_text; ?></span></a><span class="flag-throbber">&nbsp;</span>
  <?php else: ?>
