...
<div class="col-xs-6 col-sm-6 col-md-4" data-content="#colio_<?php print $fields['nid']->content;?>">
    <div class="portfolio-item  _1">
        ...
        <div class="group">
            <a href="<?php print $fields['path']->content;?>"><i class="fa fa-eye"></i> <?php print t('Detail'); ?></a>
            <a href="#"><i class="fa fa-heart-o"></i> 198</a>
            <a class="portfolio-link" href="#"><i class="fa fa-search"></i> <?php print t('Quick View'); ?></a>
        </div>
    </div>
</div>
<!-- END portfolio -->
