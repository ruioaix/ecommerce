<!-- portfolio -->
<div class="col-xs-6 col-sm-6 col-md-4 col-lg-3" data-content="#colio_<?php print $fields['nid']->content;?>">
    <div class="portfolio-item _2">
        <div class="img">
            <a href="<?php print $fields['path']->content;?>">
                <img src="<?php print $fields['field_portfolio_thumbnail']->content;?>" alt="">
            </a>
            <a class="quick-view portfolio-link" href="#"><i class="fa fa-search"></i></a>
        </div>
