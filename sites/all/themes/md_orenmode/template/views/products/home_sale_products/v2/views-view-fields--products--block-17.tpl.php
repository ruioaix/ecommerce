      ...
      <div class="action">
          ...
          <div class="group">
              <?php if(user_is_logged_in()) : ?>
                	<span class="wishlist btn btn-14">
						<?php print flag_create_link('bookmark', $fields['nid']->content); ?>
                    </span>
              		<span class="compare btn btn-14">
						<?php print flag_create_link('compare', $fields['nid']->content); ?>
                    </span>
              <?php else : ?>
                	<a href="<?php print base_path().'user'; ?>" class="btn btn-14"><i class="fa fa-heart-o"></i></a>
                	<a href="<?php print base_path().'user'; ?>" class="btn btn-14"><i class="fa fa-refresh"></i></a>
              <?php endif; ?>
              <a href="<?php print $fields['path']->content;?>" class="btn btn-14"><i class="fa fa-eye"></i></a>
          </div>
      </div>
  </div>
  <div class="text">
