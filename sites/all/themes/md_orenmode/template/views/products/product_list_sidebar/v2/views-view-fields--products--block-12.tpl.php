...
<div class="list-item  _2">
  ...
  <div class="text">
      ...
      <div class="group">
          ...
          <div class="action">
              <a href="#" class="btn btn-add-cart btn-4 text-uppercase"><i class="fa fa-cart-plus"></i> <?php print $fields['add_to_cart_form']->content;?></a>
              <?php if(user_is_logged_in()) : ?>
                    <span class="wishlist btn btn-4">
						<?php print flag_create_link('bookmark', $fields['nid']->content); ?>
                    </span>
              		<span class="compare btn btn-4">
						<?php print flag_create_link('compare', $fields['nid']->content); ?>
                    </span>
              <?php else : ?>
                    <a href="<?php print base_path().'user'; ?>" class="btn btn-4"><i class="fa fa-heart-o"></i> <span><?php print t('Add to WishList'); ?></span></a>
                    <a href="<?php print base_path().'user'; ?>" class="btn btn-4"><i class="fa fa-refresh"></i> <span><?php print t('Add to Compare'); ?></span></a>
              <?php endif; ?>
          </div>
          <div class="share">
