...
//////////////////////////////////////////////////// Add Class To Default Submit /////////////////////////////////////////////////////
    ...
    (function($){
        ...
        jQuery(document).ready(function(){
            ...
            data["hd_1_image_slide_preview"] = [];
            $("#hd_1_image_slide_preview").find("li.sortable-item").each(function(){
                data["hd_1_image_slide_preview"].push(parseInt($(this).attr("data-num"),10));
            });
            if(data["hd_1_image_slide_preview"].length <=1 ) {
                $("#hd_1_image_slide_preview").find(".md-remove").hide();
            }
			data["hd_2_image_slide_preview"] = [];
            $("#hd_2_image_slide_preview").find("li.sortable-item").each(function(){
                data["hd_2_image_slide_preview"].push(parseInt($(this).attr("data-num"),10));
            });
            if(data["hd_2_image_slide_preview"].length <=1 ) {
                $("#hd_2_image_slide_preview").find(".md-remove").hide();
            }
			data["hd_3_image_slide_preview"] = [];
            $("#hd_3_image_slide_preview").find("li.sortable-item").each(function(){
                data["hd_3_image_slide_preview"].push(parseInt($(this).attr("data-num"),10));
            });
            if(data["hd_3_image_slide_preview"].length <=1 ) {
                $("#hd_3_image_slide_preview").find(".md-remove").hide();
            }
            ...
            data["hd_1_slide_preview"] = [];
            $("#hd_1_slide_preview").find("li.sortable-item").each(function(){
                data["hd_1_slide_preview"].push(parseInt($(this).attr("data-num"),10));
            });
            if(data["hd_1_slide_preview"].length <=1 ) {
                $("#hd_1_slide_preview").find(".md-remove").hide();
            }
